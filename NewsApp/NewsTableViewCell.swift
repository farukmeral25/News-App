...
class NewsTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        newsTitleLabel.frame = CGRect(x: 10, y: 0, width: contentView.frame.size.width - 120, height: 70)
        newsSubTitleLabel.frame = CGRect(x: 10, y: 70, width: contentView.frame.size.width - 200, height: contentView.frame.size.height / 2)
        newsImageView.frame = CGRect(x:  contentView.frame.size.width - 130, y: 5, width: 140, height: contentView.frame.size.height - 10)
    }
